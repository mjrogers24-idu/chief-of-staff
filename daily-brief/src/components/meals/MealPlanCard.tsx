...
import { GROCERY_CATEGORY_LABELS, type MealPlanDoc } from "@/lib/firestore/mealPlans";
...
export function MealPlanCard({ plan, loading, error, generating, onGenerate }: MealPlanCardProps) {
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <p className="text-sm text-gray-500">
          Rolling weekly dinner plan + grocery list, generated by Gemini from the household prompt
          in the spec.
        </p>
        <button
          onClick={onGenerate}
      ...
      {!loading && !error && !plan && (
        <p className="text-sm text-gray-500">
          ...
          recent meal history to avoid repeats.
        </p>
      )}
